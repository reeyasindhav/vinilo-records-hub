...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vinilo — The Collector's Vinyl Marketplace" },
      {
        name: "description",
        content:
          "Buy and sell vinyl with transparent condition grades, rich genre filters, and seller profiles you can trust.",
      },
      { name: "author", content: "Vinilo" },
      { property: "og:title", content: "Vinilo — The Collector's Vinyl Marketplace" },
      {
        property: "og:description",
        content: "Honest grades, rare pressings, and a little more soul.",
      },
