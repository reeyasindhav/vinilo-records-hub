...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Sign Up — Vinilo" },
      {
        name: "description",
        content: "Create your Vinilo account and start buying or selling vinyl.",
      },
    ],
  }),
  component: Signup,
  ...
  return (
    <div className="paper-grain flex min-h-[calc(100vh-8rem)] items-center justify-center px-5 py-12">
      <div className="w-full max-w-md animate-rise">
        ...
        <h1 className="mt-3 text-[clamp(2rem,4vw,3rem)] leading-[0.95]">Create account</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Start listing, buying, and trading vinyl with trusted collectors.
        </p>
        ...
        >
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/login" className="text-primary underline-sweep">
              Sign in
            </Link>
          </p>
        </form>
